package alsc.hrms.controller;

import alsc.hrms.pojo.entity.Department;
import alsc.hrms.service.impl.DepartmentService;
import alsc.hrms.util.JsonMsg;
